...
{ 
    if(argc < 6)
    {
        ...
        << "(Ruta del programa) (archivoDatos) (archivoRestricciones) (numeroClusters) (Semilla) (funcion)" << endl << flush;
        return -1;
    }
    ...
    {
    case 0:
        solucion = enfriamientoSimulado(datos, matrizRest, numClusters, LAMBDA);
        break;
    case 1:
        solucion = BMB(datos, matrizRest, numClusters, LAMBDA);
        break;
    case 2:
        solucion = ILS(datos, matrizRest, numClusters, LAMBDA);
        break;
    case 3:
        solucion = ILS_ES(datos, matrizRest, numClusters, LAMBDA);
        break;
    default:
        break;
    }
    ...
    cout << "Tasa_C: " << C(datos, clusters) << "\nTasa_inf: " << infeasibility(matrizRest, distribCluster) << "\nAgg.: " << solucion.getFitness() << endl; // << " " << duracion.count() << "\n";
