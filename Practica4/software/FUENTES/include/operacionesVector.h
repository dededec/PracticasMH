...
std::vector<float> multiplicarVectorPorEntero(std::vector<float> &a, float b);
void sumaVector(std::vector<float> &a, std::vector<float> &b, std::vector<float> &resultado);
